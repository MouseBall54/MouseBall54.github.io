...
layout: single
title: >
  Critical Minerals Refining Risk: Processing Concentration Before Reserves
seo_title: >
  Critical Minerals Refining Risk: Processing Concentration Before Reserves
...
![Critical Minerals Refining Risk: Processing Concentration Before Reserves core flow summary](/images/2026-05-18-critical-minerals-refining-risk/hero.svg)
...
1. Use official international sources to identify the direction of **refining concentration**.
2. Translate **export controls** into domestic channels such as imports, electricity, exports, industrial costs, household bills, or local disaster risk.
3. Find the implementation bottleneck behind **long-term contracts**: grid capacity, permitting, finance, equipment, local acceptance, data, or maintenance.
...
Check the **baseline, period, unit, geographic coverage, and policy assumptions** first. Then translate **refining concentration**, **export controls**, and **long-term contracts** into Korea's import structure, grid geography, industrial exposure, or household cost channels.
...
- [Reading the 2026 EV Market: Separate Slowdowns from Structural Change](/en_climate_energy/ev-market-shift-2026/)
- [EV Charging and the Grid: Peak Load Before Charger Counts](/en_climate_energy/ev-charging-grid-load/)

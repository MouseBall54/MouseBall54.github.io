...
layout: single
title: >
  Metacognition Scorecard: Separate Feeling From Performance
seo_title: >
  Metacognition Scorecard: Separate Feeling From Performance
date: 2025-12-18T09:00:00+09:00
last_modified_at: 2026-05-24T23:40:00+09:00
lang: en
translation_id: expert-growth-metacognition-scorecard
header:
  teaser: /images/expert-growth-metacognition-scorecard/hero.svg
  overlay_image: /images/expert-growth-metacognition-scorecard/hero.svg
  overlay_filter: 0.34
  image_description: >
    Visual summary of the verification flow and practical checkpoints for Metacognition Scorecard: Separate Feeling From Performance.
excerpt: >
...
This guide treats **Metacognition Scorecard: Separate Feeling From Performance** as a practical checklist rather than a headline. The useful move is to track `confidence` and `actual score` together, then separate conditions that require more review from conditions that require action.

This is educational guidance for study routines and should be adjusted to the learner's course and exam context.

![Metacognition Scorecard: Separate Feeling From Performance core workflow diagram](/images/expert-growth-metacognition-scorecard/hero.svg)
...
- **Primary signal**: Track `confidence` with date, source, and owner instead of as an isolated number.
- **Secondary signal**: Mark whether a change in `actual score` should reopen the conclusion.
...
![Metacognition Scorecard: Separate Feeling From Performance practical checklist](/images/expert-growth-metacognition-scorecard/checklist.svg)

## Practical Workflow

1. Write the current problem in one sentence, such as “we are delayed because `confidence` is unclear.”
...
| --- | --- | --- |
| Primary signal | Current state of `confidence` | Prevents headline-only decisions |
| Secondary signal | Direction of `actual score` | Shows when the conclusion can change |
...
No. `confidence` and `actual score` can change meaning as rules, data, costs, or user behavior change. A quarterly review is a practical minimum for most teams.
...
For **Metacognition Scorecard: Separate Feeling From Performance**, the practical standard is not whether the reader can repeat one instruction once. Treat the topic as an evidence-informed study routine: verify retrieval practice, spacing interval, error log, and feedback source before drawing a conclusion. The result should be written as a small decision record, because future readers need to know which fact was observed, which assumption was used, and which condition would change the answer.

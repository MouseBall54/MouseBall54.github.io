...
header:
   ...
   overlay_filter: 0.5
   image_description: >
     A visual summary explaining the main topic of this post: Processing Data with Java Stream API
excerpt: >

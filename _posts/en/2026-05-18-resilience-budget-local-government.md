...
layout: single
title: >
  Local Resilience Budgets: Prevention Before Post-Disaster Recovery
seo_title: >
  Local Resilience Budgets: Prevention Before Post-Disaster Recovery
...
![Local Resilience Budgets: Prevention Before Post-Disaster Recovery core flow summary](/images/2026-05-18-resilience-budget-local-government/hero.svg)
...
Korean local governments face ageing, underground spaces, ageing infrastructure, and heavy rain together, so local risk maps and budget priorities matter before central support arrives.
...
- **prevention budget**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **ageing infrastructure**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **risk map**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **vulnerable groups**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
...
![Local Resilience Budgets: Prevention Before Post-Disaster Recovery signal checklist map](/images/2026-05-18-resilience-budget-local-government/signal-map.svg)
...
- [Korean Climate Crisis Assessment Report 2025](https://www.climate.go.kr/home/cc_data/2025/report_2025_2.pdf)
- [World Bank Climate Change Overview](https://www.worldbank.org/en/topic/climatechange/overview)

## Related Reading

- [Energy Import Bills and Exchange Rates: How a Weaker Won Reaches Power and Gas Costs](/en_climate_energy/energy-import-bill-exchange-rate/)
- [Clean-Tech Industrial Policy: Supply-Chain Position Before Subsidy Headlines](/en_climate_energy/clean-tech-industrial-policy/)

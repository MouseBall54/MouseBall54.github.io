...
1. Use official international sources to identify the direction of **target year**.
2. Translate **policy tool** into domestic channels such as imports, electricity, exports, industrial costs, household bills, or local disaster risk.
3. Find the implementation bottleneck behind **budget**: grid capacity, permitting, finance, equipment, local acceptance, data, or maintenance.

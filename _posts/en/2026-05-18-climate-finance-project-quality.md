...
seo_title: >
  Climate-Finance Project Quality: Impact Before Green Labels
date: 2026-05-18T09:34:00+09:00
...
Korean financial institutions and companies can reduce reputation risk by checking data, standards, verification, and community risk behind overseas project labels.
...
- **additionality**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **baseline**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **loss reduction**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **external verification**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
...
- [Local Resilience Budgets: Prevention Before Post-Disaster Recovery](/en_climate_energy/resilience-budget-local-government/)

...
header:
   ...
   overlay_filter: 0.5
   image_description: >
     A visual summary explaining the main topic of this post: How to Handle NumberFormatException in Java
categories:
  - en_Troubleshooting
tags:
  - Java
...
![A visual summary explaining the main topic of this post: How to Handle NumberFormatException in Java](/images/header_images/overlay_image_java.png)
## Introduction

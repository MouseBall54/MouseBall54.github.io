...
layout: single
title: >
  The Energy Transition Bottleneck Is the Grid, Not Only Generation
seo_title: >
  The Energy Transition Bottleneck Is the Grid, Not Only Generation
...
In Korea, solar expansion debates need to include transmission, distribution, and system-stability costs rather than only generation capacity.
...
- **connection queue**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **transmission investment**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **transformer supply**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **curtailment**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
...
- [Solar Curtailment: Not Too Much Power, but Power in the Wrong Place](/en_climate_energy/solar-pv-curtailment-grid/)

...
header:
   ...
   overlay_filter: 0.5
   image_description: >
     A visual summary explaining the main topic of this post: How to Fix Java's OutOfMemoryError
categories:
  - en_Troubleshooting
tags:
  - Java

...
header:
   ...
   overlay_filter: 0.5
   image_description: >
     A visual summary explaining the main topic of this post: How to Fix \"error: Your local changes to the following files would be overwritten by merge\" in Git
categories:
  - en_Troubleshooting
tags:
  - Git
...
![A visual summary explaining the main topic of this post: How to Fix \"error: Your local changes to the following files would be overwritten by merge\" in Git](/images/header_images/overlay_image_git.png)
## Introduction

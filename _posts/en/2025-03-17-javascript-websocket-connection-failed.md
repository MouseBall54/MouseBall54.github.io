...
header:
    ...
    overlay_filter: 0.5
    image_description: >
      A visual summary explaining the main topic of this post: How to Fix "WebSocket connection to '...' failed" in JavaScript
excerpt: >
...
![A visual summary explaining the main topic of this post: How to Fix "WebSocket connection to '...' failed" in JavaScript](/images/header_images/overlay_image_js.png)

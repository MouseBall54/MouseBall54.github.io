...
layout: single
title: >
  Coding Kata Routine: Solve the Same Problem in Better Ways
seo_title: >
  Coding Kata Routine: Solve the Same Problem in Better Ways
...
![Coding Kata Routine: Solve the Same Problem in Better Ways study routine flow](/images/2026-05-23-coding-kata-deliberate-practice/hero.png)
...
![Coding Kata Routine: Solve the Same Problem in Better Ways action checklist](/images/2026-05-23-coding-kata-deliberate-practice/checklist.png)
...
The record can stay short. Three fields, `small problem`, `time box`, and `refactor note`, are enough to make today's judgment visible in the next session. Move correct items to a longer interval, tag confused items with a reason, and put missed items at the top of the next session.
...
- [Project-Based Learning Portfolio: Keep Output and Reflection Together](/en_study/project-based-learning-portfolio/)

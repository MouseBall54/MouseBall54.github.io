...
header:
  ...
  overlay_filter: 0.34
  image_description: >
    Visual summary of the verification flow and practical checkpoints for AI Tool Permission Design: Split Read, Draft, and Execute.
excerpt: >
...
![AI Tool Permission Design: Split Read, Draft, and Execute core workflow diagram](/images/expert-growth-tool-permission-design/hero.svg)
...
![AI Tool Permission Design: Split Read, Draft, and Execute practical checklist](/images/expert-growth-tool-permission-design/checklist.svg)

## Practical Workflow

1. Write the current problem in one sentence, such as “we are delayed because `permission tier` is unclear.”

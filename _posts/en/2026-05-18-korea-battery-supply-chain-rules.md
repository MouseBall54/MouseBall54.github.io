...
Korean battery makers need to treat plant location and mineral-origin rules as revenue variables because they affect incentives and customer contracts.
...
- **mineral origin**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **refining location**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **recycling**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **incentive rules**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
...
![Korea Battery Supply-Chain Rules: Origin and Minerals Before Subsidies signal checklist map](/images/2026-05-18-korea-battery-supply-chain-rules/signal-map.svg)

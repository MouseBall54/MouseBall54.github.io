...
layout: single
title: >
  Reading Comprehension Prompts: Find Claims, Evidence, and Counterexamples
seo_title: >
  Reading Comprehension Prompts: Find Claims, Evidence, and Counterex...
...
![Reading Comprehension Prompts: Find Claims, Evidence, and Counterexamples study routine flow](/images/2026-05-23-reading-comprehension-prompts/hero.png)
...
![Reading Comprehension Prompts: Find Claims, Evidence, and Counterexamples action checklist](/images/2026-05-23-reading-comprehension-prompts/checklist.png)
...
The record can stay short. Three fields, `claim`, `evidence`, and `assumption`, are enough to make today's judgment visible in the next session. Move correct items to a longer interval, tag confused items with a reason, and put missed items at the top of the next session.
...
- [Spaced Review for Coding Concepts: Reuse Syntax in Projects](/en_study/spaced-review-for-coding/)
- [English Vocabulary System: Learn Words Through Context and Recall](/en_study/english-vocabulary-system/)

...
header:
    ...
    overlay_filter: 0.5
    image_description: >
      A visual summary explaining the main topic of this post: How to Fix "error: object file ... is empty" in Git
excerpt: >
...
![A visual summary explaining the main topic of this post: How to Fix "error: object file ... is empty" in Git](/images/header_images/overlay_image_git.png)

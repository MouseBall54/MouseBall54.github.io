...
layout: single
title: >
  Reading Energy Security: Separate Oil and Gas Price Shocks
seo_title: >
  Reading Energy Security: Separate Oil and Gas Price Shocks
date: 2026-05-18T09:01:00+09:00
...
Because Korea depends heavily on imported energy, a weaker won combined with higher fuel prices can hit corporate costs and household utility debates together.
...
- **Brent and Dubai crude**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **LNG spot price**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **KRW/USD exchange rate**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
- **commercial inventories**: read direction, duration, policy response, and domestic transmission before treating it as a standalone number.
...
- [Renewables to 2030: Installed Capacity Is Not the Whole Story](/en_climate_energy/renewables-growth-forecast-2030/)

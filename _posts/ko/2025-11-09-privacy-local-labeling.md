...
tags:
  ...
  - Labeling
---
이 글은 **민감한 이미지 라벨링과 로컬 우선 작업: 업로드 전에 확인할 보안 기준**를 라벨링 속도가 아니라 데이터셋 품질 기준으로 정리합니다. Easy Labeling은 작업을 빠르게 만들 수 있지만, 학습 가능한 데이터는 클래스 규칙과 검수 루틴이 함께 있을 때 만들어집니다.

...
한국 금융기관과 기업은 해외 프로젝트의 녹색 라벨보다 데이터, 기준, 검증, 지역사회 리스크를 확인해야 평판 리스크를 줄일 수 있다.
...
- **추가성**: 단일 수치보다 방향, 지속 기간, 정책 반응, 국내 전달 경로를 함께 확인합니다.
- **기준선**: 단일 수치보다 방향, 지속 기간, 정책 반응, 국내 전달 경로를 함께 확인합니다.
- **피해 감소**: 단일 수치보다 방향, 지속 기간, 정책 반응, 국내 전달 경로를 함께 확인합니다.
- **외부 검증**: 단일 수치보다 방향, 지속 기간, 정책 반응, 국내 전달 경로를 함께 확인합니다.

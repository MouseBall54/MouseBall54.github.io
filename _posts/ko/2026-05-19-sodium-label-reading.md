...
- **1회 제공량**: 이 신호가 보이면 기록하고, 악화되거나 안전 문제가 있으면 전문가에게 확인합니다.
- **소스 사용량**: 이 신호가 보이면 기록하고, 악화되거나 안전 문제가 있으면 전문가에게 확인합니다.
- **가공식품 빈도**: 이 신호가 보이면 기록하고, 악화되거나 안전 문제가 있으면 전문가에게 확인합니다.
- **국물 섭취**: 이 신호가 보이면 기록하고, 악화되거나 안전 문제가 있으면 전문가에게 확인합니다.

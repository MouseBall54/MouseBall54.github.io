...
한국은 식량과 에너지 수입 비중이 높아 국제 곡물가격, 환율, 해상운임, 국내 수급 대책을 한 번에 봐야 한다.
...
- **가뭄·홍수**: 단일 수치보다 방향, 지속 기간, 정책 반응, 국내 전달 경로를 함께 확인합니다.
- **비료 가격**: 단일 수치보다 방향, 지속 기간, 정책 반응, 국내 전달 경로를 함께 확인합니다.
- **해상운임**: 단일 수치보다 방향, 지속 기간, 정책 반응, 국내 전달 경로를 함께 확인합니다.
- **곡물 재고**: 단일 수치보다 방향, 지속 기간, 정책 반응, 국내 전달 경로를 함께 확인합니다.

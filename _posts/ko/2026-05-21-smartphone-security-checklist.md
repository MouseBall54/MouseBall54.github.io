...
seo_title: >
  스마트폰 보안 체크리스트: 앱 권한과 잠금화면부터 점검하기
date: 2026-05-21T10:40:00+09:00
...
- **접근성 권한**: 이 신호가 보이면 즉시 멈추고 공식 경로로 다시 확인합니다.
- **알림 읽기 권한**: 이 신호가 보이면 즉시 멈추고 공식 경로로 다시 확인합니다.
- **출처 불명 앱**: 이 신호가 보이면 즉시 멈추고 공식 경로로 다시 확인합니다.
- **잠금화면 미설정**: 이 신호가 보이면 즉시 멈추고 공식 경로로 다시 확인합니다.

위험 신호가 하나만 보여도 바로 차단하거나 삭제할 필요는 없습니다. 먼저 화면을 캡처하고, 공식 앱이나 주소창 직접 입력처럼 통제 가능한 경로로 다시 확인하세요.

![스마트폰 보안 체크리스트: 앱 권한과 잠금화면부터 점검하기 대응 체크리스트](/images/2026-05-21-smartphone-security-checklist/checklist.svg)
